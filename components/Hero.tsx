...
export default function Hero() {
  return (
    <section id="top" className="border-b border-line/60 bg-paper">
      <div className="mx-auto grid max-w-content items-center gap-10 px-5 py-16 md:grid-cols-2 md:px-8 md:py-24">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a
              href="#idea"
              className="rounded-full border border-ink/25 px-7 py-3 font-medium text-ink transition-colors hover:border-copper hover:text-copper-deep"
            >
              {hero.secondaryCta}
            </a>
          </div>
